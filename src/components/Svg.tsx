...
export const Svg: {
    tooth: ToothNumber;
    paths: (tooth: ToothNumber, stroke?: string, fill?: string) => ReactNode;
}[] = [
        {
            tooth: "11",
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none"
                        xmlSpace="preserve"
                        x={120.37785}
                        y={17.284296}
                        style={TEXT_STYLE}
                    >
                        <tspan x={120.37785} y={17.284296} fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path className="tooth-11 tooth-11-parent"
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }}
                    />

                    <path className="tooth-11"
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="85.630409" y="28.142862"
                        style={TEXT_STYLE}>
                        <tspan x="85.630409" y="28.142862" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="56.67421" y="43.344887"
                        style={{ ...TEXT_STYLE }}>
                        <tspan x="56.67421" y="43.344887" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="42.92001" y="64.338097"
                        style={{ ...TEXT_STYLE }}>
                        <tspan x="42.92001" y="64.338097" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="32.785339" y="88.226982"
                        style={{ ...TEXT_STYLE }}>
                        <tspan x="32.785339" y="88.226982" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="19.031139" y="110.66804"
                        style={{ ...TEXT_STYLE }}>
                        <tspan x="19.031139" y="110.66804" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    ...
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="12.515995" y="141.07207"
                        style={{ ...TEXT_STYLE }}>
                        <tspan x="12.515995" y="141.07207" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="8.8964691" y="172.2"
                        style={{ ...TEXT_STYLE }}>
                        <tspan x="8.8964691" y="172.2" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="155.84921" y="17.284296"
                        style={TEXT_STYLE}>
                        <tspan x="155.84921" y="17.284296" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="192.76837" y="29.590677" style={TEXT_STYLE}>
                        <tspan x="192.76837" y="29.590677" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    ...
                    <path d="m 207.1137,55.147401 c -6.13808,6.23388 -2.06668,5.31188 4.54339,2.61055" style={{ ...PATH_STYLE, stroke, fill }}
                    />
                </>
            }
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="236.20268" y="64.338097"
                        style={TEXT_STYLE}>
                        <tspan x="236.20268" y="64.338097" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="247.06125" y="86.779167"
                        style={TEXT_STYLE}>
                        <tspan x="247.06125" y="86.779167" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="258.64374" y="109.22027"
                        style={TEXT_STYLE}>
                        <tspan x="258.64374" y="109.22027" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="264.43497" y="139.62425"
                        style={TEXT_STYLE}>
                        <tspan x="264.43497" y="139.62425" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="268.77841" y="169.3044"
                        style={TEXT_STYLE}>
                        <tspan x="268.77841" y="169.3044" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="151.50578" y="360.41531"
                        style={TEXT_STYLE}>
                        <tspan x="151.50578" y="360.41531" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="176.84245" y="355.34799"
                        style={TEXT_STYLE}>
                        <tspan x="176.84245" y="355.34799" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="202.17912" y="346.6611"
                        style={TEXT_STYLE}>
                        <tspan x="202.17912" y="346.6611" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="222.44849" y="330.01129"
                        style={TEXT_STYLE}>
                        <tspan x="222.44849" y="330.01129" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="240.5461" y="309.01804"
                        style={TEXT_STYLE}>
                        <tspan x="240.5461" y="309.01804" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="257.91986" y="282.95749"
                        style={TEXT_STYLE}>
                        <tspan x="257.91986" y="282.95749" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="265.15891" y="245.31441"
                        style={TEXT_STYLE}>
                        <tspan x="265.15891" y="245.31441" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="265.15891" y="214.18651"
                        style={TEXT_STYLE}>
                        <tspan x="265.15891" y="214.18651" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
...

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="128.34082" y="360.41531"
                        style={TEXT_STYLE}>
                        <tspan x="128.34082" y="360.41531" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="100.10851" y="356.79581"
                        style={TEXT_STYLE}>
                        <tspan x="100.10851" y="356.79581" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="76.94355" y="347.38501"
                        style={TEXT_STYLE}>
                        <tspan x="76.94355" y="347.38501" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="55.950298" y="330.01129"
                        style={TEXT_STYLE}>
                        <tspan x="55.950298" y="330.01129" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="38.57658" y="310.46585"
                        style={TEXT_STYLE}>
                        <tspan x="38.57658" y="310.46585" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="20.478951" y="287.30087"
                        style={TEXT_STYLE}>
                        <tspan x="20.478951" y="287.30087" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="12.515995" y="244.5905"
                        style={TEXT_STYLE}>
                        <tspan x="12.515995" y="244.5905" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="12.515995" y="214.18651"
                        style={TEXT_STYLE}>
                        <tspan x="12.515995" y="214.18651" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="149.33405" y="276.44232"
                        style={TEXT_STYLE}>
                        <tspan x="149.33405" y="276.44232" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="169.60339" y="271.375"
                        style={TEXT_STYLE}>
                        <tspan x="169.60339" y="271.375" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 168.66926,246.0279 c 1.35346,2.40788 5.10664,4.80797 0.86127,7.23378"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="187.70103" y="262.68811"
                        style={TEXT_STYLE}>
                        <tspan x="187.70103" y="262.68811" fill={stroke}>
                            {toothNumber}
                        </tspan>
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="202.90305" y="244.5905"
                        style={TEXT_STYLE}>
                        <tspan x="202.90305" y="244.5905" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path d="m 186.92525,230.33355 c -0.12671,0.85785 0.32871,1.81549 -0.68173,2.52203"
                        style={{ ...PATH_STYLE, stroke, fill }} />
        ...
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="213.76163" y="217.08217"
                        style={TEXT_STYLE}>
                        <tspan x="213.76163" y="217.08217" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 198.46021,210.97776 c 0.0955,-2.03006 0.60134,-2.9397 1.2613,-3.42845"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 201.5053,201.27629 -0.1547,1.80957"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="131.23643" y="275.71838"
                        style={TEXT_STYLE}>
                        <tspan x="131.23643" y="275.71838" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
...

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="109.51928" y="269.92715"
                        style={TEXT_STYLE}>
                        <tspan x="109.51928" y="269.92715" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>

                    <path d="m 122.63179,245.99259 c -1.35347,2.40782 -5.10665,4.80799 -0.86126,7.23371"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path
...

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="91.421661" y="259.79251"
                        style={TEXT_STYLE}>
                        <tspan x="91.421661" y="259.79251" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 107.157,239.80493 c 0.29635,-1.61148 1.2667,-2.84003 3.39037,-3.41354"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path
...

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="76.94355" y="240.97096"
                        style={TEXT_STYLE}>
                        <tspan x="76.94355" y="240.97096" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 104.37579,230.29817 c 0.12671,0.85787 -0.32871,1.81556 0.68174,2.52204"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path
...

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="64.637154" y="217.08217"
                        style={TEXT_STYLE}>
                        <tspan x="64.637154" y="217.08217" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 89.795748,201.24091 0.154722,1.80957"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="152.22969" y="100.53336"
                        style={TEXT_STYLE}>
                        <tspan x="152.22969" y="100.53336" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
...

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="176.11855" y="110.66804"
                        style={TEXT_STYLE}>
                        <tspan x="176.11855" y="110.66804" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 169.74074,117.64185 c -0.34636,1.94088 -0.66909,3.9321 -1.6535,4.51489"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 172.06141,125.71178 c -0.1433,-1.6529 2.10639,-2.35221 3.95768,-3.21022"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="192.76837" y="120.80273"
                        style={TEXT_STYLE}>
                        <tspan x="192.76837" y="120.80273" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 182.93738,126.12663 c -1.844,6.51849 -2.6435,8.05683 2.17539,4.0166"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 187.23393,132.41724 c -4.06,4.46477 -1.36697,3.80445 3.00523,1.8697"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="207.97037" y="139.62425"
                        style={TEXT_STYLE}>
                        <tspan x="207.97037" y="139.62425" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 188.95105,143.47675 c 2.10502,0.32885 5.21636,0.1975 5.78846,1.22738"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 201.0406,150.97069 c -2.14361,0.88152 -3.05166,-0.0435 -4.17982,-0.64718"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 199.28078,153.6762 -0.97192,-2.69903"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="214.48553" y="164.96092"
                        style={TEXT_STYLE}>
                        <tspan x="214.48553" y="164.96092" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
...

        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="125.11855" y="100.66804"
                        style={TEXT_STYLE}>
                        <tspan x="125.11855" y="100.66804" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="176.11855" y="110.66804"
                        ...
                        style={TEXT_STYLE}>
                        <tspan x="100.11855" y="110.66804" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path d="m 120.73164,117.50203 c 0.33235,1.866 0.64206,3.78039 1.5867,4.3407"
                        style={{ ...PATH_STYLE, stroke, fill }} />

                    <path d="m 117.09124,123.9055 c 0.13748,-1.58912 -2.02127,-2.26145 -3.79782,-3.08637"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="87.802124" y="124.42228"
                        style={TEXT_STYLE}>
                        <tspan x="87.802124" y="124.42228" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path
                        ...
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 108.49459,127.00418 c 1.84406,6.51847 2.6435,8.05682 -2.17536,4.01659"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                    <path d="m 106.18196,133.29479 c 4.06,4.46477 1.36698,3.80443 -3.00522,1.86967"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="73.32402" y="141.07207"
                        style={TEXT_STYLE}>
                        <tspan x="73.32402" y="141.07207" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
                    ...
                    <path d="m 103.32397,146.27386 c -2.105,0.32886 -5.216376,0.19749 -5.788465,1.22738"
                        style={{ ...PATH_STYLE, stroke, fill }} />

                    <path d="m 92.375329,153.76781 c 2.143597,0.88152 3.051647,-0.0435 4.179828,-0.64719"
                        style={{ ...PATH_STYLE, stroke, fill }} />

                    <path d="m 94.135111,156.47331 0.971964,-2.69902"
                        style={{ ...PATH_STYLE, stroke, fill }} />
                </>
            }
        },
        {
            ...
            paths: (toothNumber, stroke = 'none', fill = 'none') => {
                return <>
                    <text className="cursor-pointer select-none" xmlSpace="preserve" x="63.189354" y="163.51317"
                        style={TEXT_STYLE}>
                        <tspan x="63.189354" y="163.51317" fill={stroke}>
                            {toothNumber}
                        </tspan>
                    </text>
